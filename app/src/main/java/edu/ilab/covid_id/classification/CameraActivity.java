...
import edu.ilab.covid_id.classification.tflite.Classifier.Recognition;
...
public abstract class CameraActivity extends AppCompatActivity
  ...
  public void onPreviewFrame(final byte[] bytes, final Camera camera) {
    ...
    try {
      ...
      if (rgbBytes == null) {
        ...
        onPreviewSizeChosen(new Size(previewSize.width, previewSize.height), 90);  //SHIVALI   why hardcoded to 90???
      }
  ...
  protected void showResultsInBottomSheet(List<Recognition> results) {
    ...
    Log.d("MY_LOG", String.valueOf(results.size()));
